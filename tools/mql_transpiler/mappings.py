...
COMMON_FUNC_MAP: Dict[str, str] = {
    ...
    # ── MQL5 Position/History (stateful — SDK equivalent shown in comment) ──
    "PositionSelect": "TRANSPILER-GAP: PositionSelect — use for pos in self.broker.positions()",
    "PositionSelectByTicket": "TRANSPILER-GAP: PositionSelectByTicket — use self.broker.positions(ticket=...)",
    ...
    "HistorySelectByPosition": "TRANSPILER-GAP: HistorySelectByPosition — use self.broker.deals(position_id=...)",
    ...
    "HistoryDealGetDouble": "TRANSPILER-GAP: HistoryDealGetDouble — use deal.price etc.",
    "HistoryDealGetInteger": "TRANSPILER-GAP: HistoryDealGetInteger — use deal.ticket etc.",
    "HistoryDealGetString": "TRANSPILER-GAP: HistoryDealGetString — use deal.symbol etc.",
    ...
    "HistoryOrderGetDouble": "TRANSPILER-GAP: HistoryOrderGetDouble — use order.price etc.",
    "HistoryOrderGetInteger": "TRANSPILER-GAP: HistoryOrderGetInteger — use order.ticket etc.",
    "HistoryOrderGetString": "TRANSPILER-GAP: HistoryOrderGetString — use order.symbol etc.",
    # ── MT5 trade support (broker-side, not available in SDK) ────────
    ...
    # ── SymbolInfo getters (map to symbol_info().attr) ──────────────
