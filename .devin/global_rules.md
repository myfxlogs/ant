...
- `CLAUDE.md` is the project constitution; `AGENTS.md` is the concise entry point.
- `docs/audits/tech-debt-registry.md` is the task workbench and authoritative open-gap ledger.
...
- New sessions start by reading the relevant handover entry, registry entry, `AGENTS.md`, and `CLAUDE.md`; read history before rewriting behavior.
