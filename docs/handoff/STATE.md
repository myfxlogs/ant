...
| VM-LIVE-VENUE-1 venue 常量真值化（F 系残余 R2：TRADE_MODE/FREEZE_LEVEL/EXEMODE/TRADEALLOWED/FREEZELEVEL 硬编码） | ⚠️待独立复审 | 施工完成（S1-S6 全落位：SymbolParam.TradeExemode/mt4 Ex==nil→-1×3/mt5 Freeze+Exemode=-1/proto LSC 41-43+Tick 25-27 双端 regen/backfill -1 哨兵前置+逐字透传/runner 直填链/SimBroker 模型常量 4/0/2/builtin 22·26·27·32 接线+TRADEALLOWED 改 IsTradeAllowed∧mode∈{1,2,4}；T1-T5 + M1/M2/M3 mutation RED→GREEN；影响包 -count=1 全绿）。待 Devin CLI 复审验收 |
