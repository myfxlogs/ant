...
- **下一步**: 派 QS-2.3（vm.ctx 非 nil 不变量，handoff 待落盘）；QS 顺序 1.4✅→1.6✅→1.3✅→1.2a✅→1.7-INV✅→2.2✅→2.4✅→2.5✅→2.3，QS-3-BASELINE 贯穿。S9 回填脚本仍待编写。
- **清扫上翻**: 无私有记忆需清扫。
...
- **QS-2.3 / 3-BASELINE** 🟦open — VM 管线质量方案 v2（D-009）；详见 registry + spec §2 核验表
