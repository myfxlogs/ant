...
| VM-LIVE-VENUE-1 venue 常量真值化（F 系残余 R2：TRADE_MODE/FREEZE_LEVEL/EXEMODE/TRADEALLOWED/FREEZELEVEL 硬编码） | 🟦open-待施工 | 设计+派工双落档自审通过（design-vm-venue-const-r2.md + builder-handoff-vm-venue-const-r2.md，commit 2a8f7f11）：-1=unknown 哨兵全链/mt4 Ex==nil→-1/mt5 pb 无字段→-1/proto LSC 41-43+Tick 25-27/SimBroker 模型常量保留/MODE_TRADEALLOWED 改 symbol∧账户双轴 |
