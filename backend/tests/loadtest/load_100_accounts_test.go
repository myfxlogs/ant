...
// Test100AccountsNoSpill verifies CHWriter handles 100-account peak without spilling.
// Mock broker generates 25k tick/s; after 5min, spill_writes must be 0
// and e2e latency P99 < 500ms (ADR-0011 §6).
func Test100AccountsNoSpill(t *testing.T) {
	// When mock broker infrastructure is available:
