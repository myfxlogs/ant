...
func executionLogToProto(l *model.StrategyExecutionLog) *antv1.ExecutionLog {
	e := &antv1.ExecutionLog{
		...
		SignalPrice:     l.SignalPrice.InexactFloat64(),
		SignalVolume:    l.SignalVolume.InexactFloat64(),
		SignalStopLoss:  l.SignalStopLoss.InexactFloat64(),
		SignalTakeProfit: l.SignalTakeProfit.InexactFloat64(),
		ExecutedOrderId: l.ExecutedOrderID,
		ExecutedPrice:   l.ExecutedPrice.InexactFloat64(),
		ExecutedVolume:  l.ExecutedVolume.InexactFloat64(),
...
func orderHistoryToProto(o *model.OrderHistory) *antv1.OrderHistoryRecord {
	r := &antv1.OrderHistoryRecord{
		...
		Lots:       o.Volume.InexactFloat64(),
		OpenPrice:  o.OpenPrice.InexactFloat64(),
		ClosePrice: o.ClosePrice.InexactFloat64(),
		Profit:     o.Profit.InexactFloat64(),
