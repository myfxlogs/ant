...
var MQLConstants = map[string]Value{
	...
	// VM-ENUM-NUMBERING-1: values aligned to the real MQL4 numbering.
	// Non-real modes (MODE_SWAPTYPE/MODE_SWAPMODE/MODE_PROFITCALCMODE/
	// MODE_MARGINCALCMODE) removed — the names no longer resolve as constants.
	"MODE_LOW":               IntVal(1),
	"MODE_HIGH":              IntVal(2),
	"MODE_TIME":              IntVal(5),
	...
	"MODE_TICKVALUE":         IntVal(16),
	"MODE_TICKSIZE":          IntVal(17),
	"MODE_SWAPLONG":          IntVal(18),
	"MODE_SWAPSHORT":         IntVal(19),
	"MODE_STARTING":          IntVal(20),
	"MODE_EXPIRATION":        IntVal(21),
	"MODE_TRADEALLOWED":      IntVal(22),
	"MODE_MINLOT":            IntVal(23),
	"MODE_MAXLOT":            IntVal(25),
	"MODE_LOTSTEP":           IntVal(24),
	"MODE_MARGININIT":        IntVal(28),
	"MODE_MARGINMAINTENANCE": IntVal(29),
	"MODE_MARGINHEDGED":      IntVal(30),
	"MODE_MARGINREQUIRED":    IntVal(31),
	"MODE_FREEZELEVEL":       IntVal(32),
	"MODE_CLOSEBY_ALLOWED":   IntVal(33),
	...
	// MQL5 short timeframe constants (used as iXxx(symbol, "H1", ...) arguments)
	"M1":  IntVal(1),
	"M5":  IntVal(5),
	"M15": IntVal(15),
	"M30": IntVal(30),
	...
	// ENUM_SYMBOL_INFO_INTEGER (current doc order). Props without an
	// authoritative source get no constant — the names no longer resolve
	// (SYMBOL_SWAP_ROLLOVER3DAYS removed).
	"SYMBOL_CUSTOM":             IntVal(3),
	"SYMBOL_CHART_MODE":         IntVal(5),
	"SYMBOL_EXIST":              IntVal(6),
	...
	"SYMBOL_TICKS_BOOKDEPTH":    IntVal(20),
	"SYMBOL_TRADE_CALC_MODE":    IntVal(21),
	"SYMBOL_TRADE_MODE":         IntVal(22),
	"SYMBOL_START_TIME":         IntVal(23),
	"SYMBOL_EXPIRATION_TIME":    IntVal(24),
	"SYMBOL_TRADE_STOPS_LEVEL":  IntVal(25),
	"SYMBOL_TRADE_FREEZE_LEVEL": IntVal(26),
	"SYMBOL_TRADE_EXEMODE":      IntVal(27),
	"SYMBOL_SWAP_MODE":          IntVal(28),
	"SYMBOL_ORDER_MODE":         IntVal(33),
	"SYMBOL_ORDER_GTC_MODE":     IntVal(34),
	// ENUM_SYMBOL_INFO_DOUBLE (current doc order). BID=0 stays.
	"SYMBOL_BID":                 IntVal(0),
	"SYMBOL_ASK":                 IntVal(3),
	"SYMBOL_LAST":                IntVal(6),
	"SYMBOL_LASTHIGH":            IntVal(7),
	"SYMBOL_LASTLOW":             IntVal(8),
	"SYMBOL_VOLUME_REAL":         IntVal(9),
	"SYMBOL_VOLUMEHIGH_REAL":     IntVal(10),
	"SYMBOL_VOLUMELOW_REAL":      IntVal(11),
	"SYMBOL_POINT":               IntVal(13),
	"SYMBOL_TRADE_TICK_VALUE":    IntVal(14),
	"SYMBOL_TRADE_TICK_SIZE":     IntVal(17),
	"SYMBOL_TRADE_CONTRACT_SIZE": IntVal(18),
	"SYMBOL_VOLUME_MIN":          IntVal(22),
	"SYMBOL_VOLUME_MAX":          IntVal(23),
	"SYMBOL_VOLUME_STEP":         IntVal(24),
	"SYMBOL_SWAP_LONG":           IntVal(26),
	"SYMBOL_SWAP_SHORT":          IntVal(27),

	// ── MQL5 symbol return-value enums (used by real branches above) ───
	"SYMBOL_CHART_MODE_BID":               IntVal(0),
	"SYMBOL_CHART_MODE_LAST":              IntVal(1),
	"SYMBOL_CALC_MODE_FOREX":              IntVal(0),
	"SYMBOL_SWAP_MODE_POINTS":             IntVal(1),
	"SYMBOL_EXPIRATION_GTC":               IntVal(1),
	"SYMBOL_ORDER_MARKET":                 IntVal(1),
	"SYMBOL_ORDER_LIMIT":                  IntVal(2),
	"SYMBOL_ORDER_STOP":                   IntVal(4),
	"SYMBOL_ORDER_STOP_LIMIT":             IntVal(8),
	"SYMBOL_ORDER_SL":                     IntVal(16),
	"SYMBOL_ORDER_TP":                     IntVal(32),
	"SYMBOL_ORDER_CLOSEBY":                IntVal(64),
	"SYMBOL_ORDERS_GTC":                   IntVal(0),
	"SYMBOL_ORDERS_DAILY":                 IntVal(1),
	"SYMBOL_ORDERS_DAILY_EXCLUDING_STOPS": IntVal(2),
