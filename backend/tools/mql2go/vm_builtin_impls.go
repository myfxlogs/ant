...
func registerArrayBuiltins() {
	...
	builtinRegistry[id("ArrayFree")].fn = builtinArrayFree
	builtinRegistry[id("ArrayInitialize")].fn = builtinArrayInitialize
	builtinRegistry[id("ArrayFill")].fn = builtinArrayFill
	builtinRegistry[id("ArrayRange")].fn = builtinArrayRange
	builtinRegistry[id("ArrayIsSeries")].fn = builtinArrayIsSeries
