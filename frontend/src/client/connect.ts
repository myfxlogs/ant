...
import { CreditService, AdminCreditService } from "../gen/ant/v1/credit_pb";
...
export const creditClient = createClient(CreditService, transport);
export const adminCreditClient = createClient(AdminCreditService, transport);
