...
import { AdminStrategyService } from "../gen/ant/v1/admin_strategy_pb";
...
export const adminStrategyClient = createClient(AdminStrategyService, transport);
...
import { StrategyImportService, AnalyzeCodeRequestSchema, AnalyzeCodeResponseSchema, GenerateCodeRequestSchema, GenerateCodeResponseSchema, ImportStrategyRequestSchema, ImportStrategyResponseSchema } from "../gen/ant/v1/strategy_import_pb";
