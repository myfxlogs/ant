...
const StrategyTuning = {
  "strategy": {
    "tuning": {
      ...
      "degradationTip": "Mức giảm lợi nhuận khi kiểm tra trên dữ liệu chưa thấy so với dữ liệu huấn luyện. Càng thấp càng tốt.",
      "enabledCombinations": "{{enabled}} bật · {{combos}} tổ hợp",
      "grade": "Xếp Hạng",
      "gradeTip": "Xếp hạng tổng hợp từ A (tốt nhất) đến E (tệ nhất).",
      ...
      "oosScore": "Điểm OOS",
      "oosScoreTip": "Điểm từ backtest trên dữ liệu không dùng trong huấn luyện. Đo độ bền vững thực tế.",
      "optimizerMethod": "Phương Pháp Tối Ưu",
      "overfit": "Quá Khớp",
      "overfitTip": "Chiến lược hoạt động tốt trên dữ liệu huấn luyện nhưng kém trên dữ liệu mới — tham số chỉ ghi nhớ lịch sử chứ không có hiệu lực thực.",
      "overfitWarning": "⚠ QUÁ KHỚP",
      "parameterDimensions": "Chiều Tham Số",
      "parameters": "Tham Số",
      "parametersTip": "Các giá trị tham số được thử trong ứng viên này.",
      "preview": "Xem trước tín hiệu",
      "previewTitle": "Xem Trước ({{shown}} / {{total}})",
      "rank": "#",
      "requiresAI": "Cần cấu hình nhà cung cấp AI",
      "results": "Kết Quả ({{count}})",
      "run": "Chạy ({{count}} lần backtest)",
      "score": "Điểm",
      "scoreTip": "Điểm tổng hợp (0-100) kết hợp lợi nhuận, Sharpe, tỷ lệ thắng, drawdown, v.v.",
      "started": "Tinh Chỉnh Thông Minh đã bắt đầu",
      "summary": "Tóm Tắt",
      "summaryTip": "Mô tả ngắn gọn về kết quả ứng viên.",
