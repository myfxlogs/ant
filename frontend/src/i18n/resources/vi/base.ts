...
{{intent}}`,
  ...
  marketplace: {
    ...
    empty: 'Chưa có chiến lược nào',
    noSubscriptions: 'Chưa đăng ký',
    card: {
      free: 'Miễn phí', rent: '¥{{amount}}/tháng', buy: '¥{{amount}}',
      owned: 'Đã mua', users: 'Người dùng',
      winRate: 'Tỉ lệ', pnl: 'PnL',
      subscribers: 'Người đăng ký',
      by: 'bởi',
    },
    assetClass: { forex: 'Forex', crypto: 'Crypto', commodity: 'Hàng hóa', index: 'Index', stock: 'Cổ phiếu', other: 'Khác' },
    risk: { low: 'Thấp', medium: 'Trung bình', high: 'Cao' },
    messages: {
      loginFirst: 'Vui lòng đăng nhập',
      subscribed: 'Đã thêm',
      subscribeFailed: 'Thất bại',
      paymentComingSoon: 'Sắp ra mắt',
    },
    detail: {
      author: 'Tác giả', price: 'Giá',
      assetClass: 'Loại', riskLevel: 'Rủi ro',
      subscribers: 'Người đăng ký', avgRating: 'Đánh giá',
      description: 'Mô tả', tags: 'Thẻ',
      getFree: 'Nhận miễn phí', buyNow: 'Mua ngay',
      rentPrice: '¥{{amount}} / tháng', buyPrice: '¥{{amount}} một lần',
      comments: 'Bình luận', noComments: 'Chưa có',
      commentPlaceholder: 'Viết bình luận...',
    },
    purchases: {
      empty: 'Chưa mua gì. Duyệt thị trường nào.',
      strategy: 'Chiến lược', date: 'Ngày mua',
      status: 'Trạng thái', actions: 'Hành động',
    },
    author: {
      empty: 'Chưa công bố. Vào Thư viện chiến lược để công bố.',
      published: 'Đã công bố', subscribers: 'Người đăng ký',
      avgRating: 'Đánh giá TB', noPublished: 'Chưa có',
    },
    priceModel: { free: 'Miễn phí', subscription: 'Đăng ký', performanceFee: 'Phí hiệu suất' },
  },
