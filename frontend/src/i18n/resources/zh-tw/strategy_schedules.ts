    ...
    "schedules": {
      "editModal": {
        "advanced": {
          ...
          "parametersJsonExtra": "策略的 JSON 引數",
      ...
      "messages": {
        "defaultTemplateNotFound": "預設模板不存在，請重新整理頁面重試",
        "executeFailed": "執行失敗",
        "importDefaultTemplateFailedNoId": "匯入預設模板失敗：未返回模板ID",
        "noOrderableSignal": "沒有可下單的訊號",
        "orderFailed": "下單失敗",
        "orderSubmitted": "已提交下單",
        "parametersParseFailed": "引數解析失敗",
        "signalHoldCannotOrder": "當前訊號為 hold/無交易動作，不能下單",
      ...
      "validation": {
        "parametersMustBeJsonObject": "引數必須為 JSON 物件"
      },
      "createSchedule": "建立排程",
      "enableCount": "啟用次數",
      "nextRunAt": "下次執行",
