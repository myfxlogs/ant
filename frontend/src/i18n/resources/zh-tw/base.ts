        ...
        "risk": {
          "admin": {
            ...
            "jurisdiction": {
              ...
              "override": "豁免",
              "overrideWarning": "此用户来自受制裁國家，授予豁免将允許交易。",
              "pending": "待審核",
              "questionnaire": "問卷",
              "rejected": "已拒絕",
              "revokeOverride": "撤銷豁免",
            ...
            "userManagement": {
              ...
              "passwordForm": {
                ...
                "validation": {
                  ...
                  "passwordMin8": "密碼至少8位元",
                  "passwordMismatch": "两次密碼不一致",
                  "passwordMustContainLettersAndNumbers": "密碼必须包含字母和數字"
                }
              },
              "roles": {
                "audit": "審計",
