...
{{intent}}`,
  ...
  marketplace: {
    ...
    detail: {
      ...
      rentPrice: '¥{{amount}} / 月', buyPrice: '¥{{amount}} 買斷',
      comments: '評論', noComments: '暫無評論',
      commentPlaceholder: '寫評論...',
    },
    purchases: {
      empty: '還沒有購買。瀏覽市場發現策略吧。',
      strategy: '策略', date: '購買日期',
      status: '狀態', actions: '操作',
    },
    author: {
      empty: '還沒有發佈策略。前往策略庫發佈一個吧。',
      published: '已發佈', subscribers: '訂閱者',
      avgRating: '平均評分', noPublished: '暫無已發佈策略',
    },
    priceModel: { free: '免費', subscription: '訂閱', performanceFee: '業績提成' },
  },
    searchPlaceholder: '搜尋策略...',
