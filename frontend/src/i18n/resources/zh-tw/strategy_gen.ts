...
const StrategyGen = {
  "strategy": {
    "gen": {
      ...
      "planHint": "您可以討論此計畫，或說 \"generate code\" 開始實作。",
      "planInputPlaceholder": "分享您的想法...",
      ...
      "totalTrades": "總交易數",
      "failed": "失敗",
      "noMarketData": "無可用市場數據",
      "noMarketDataHint": "請選擇交易帳戶和品種以載入行情數據，然後重試。",
      "plan": "策略方案",
      "finalCode": "最終策略程式碼",
      "copy": "複製",
