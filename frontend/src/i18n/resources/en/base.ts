...
const Base = {
  "admin": {
    ...
    "accountMgmt": {
      ...
      "frozenSuccess": "Account frozen",
      "unfrozenSuccess": "Account unfrozen",
      "freezeFailed": "Freeze failed",
      "unfreezeFailed": "Unfreeze failed",
      "freezeConfirm": "Freeze this account?",
    ...
    "aiGateway": {
      ...
      "subtitle": "Manage AI providers, models, and pricing. Users select from available models and are billed per token from their wallet.",
      "loadProvidersFailed": "Failed to load provider list",
      "loadModelsFailed": "Failed to load model list",
      "saveSuccess": "Saved successfully",
      "addProviderTodo": "Adding providers requires backend API support",
      "toggleStatusFailed": "Failed to toggle status",
      "toggleFailed": "Toggle failed",
      "deleted": "Deleted",
      "deleteFailed": "Delete failed",
      "deleteModelConfirm": "Confirm delete this model?",
      "refresh": "Refresh",
      ...
      "apiKeyHintExisting": "Leave blank to keep existing key",
      "apiKeyHintNew": "API key, encrypted at rest",
      "apiKeyPlaceholderExisting": "Leave blank to keep",
    ...
    "agentSettings": {
      ...
      "permissionRulesFormat": "Format: ",
      "permissionRulesExample": "Example: ",
      "permissionRulesAdd": "Add rules: create new setting with key ",
      "newSetting": "New Managed Setting",
      "editSetting": "Edit: {{name}}",
      "save": "Save",
      "cancel": "Cancel",
      "settingKey": "Setting Key",
      "settingKeyPlaceholder": "e.g. allowed_models, disable_live_trading, permission.rule.1",
      "settingValue": "Value",
      "settingValuePlaceholder": "e.g. claude-sonnet-5,deepseek-v4",
      "settingLabels": {
        "allowed_models": "Allowed Models (comma-separated)",
        "enforce_allowed_models": "Enforce Allowed Models",
        "max_cost_ceiling_usd": "Max Cost Ceiling per Strategy (USD)",
        "max_iterations_per_strategy": "Max Iterations per Strategy",
        "disable_live_trading": "Disable Live Trading",
        "required_risk_gates": "Required Risk Gates (comma-separated)",
        "audit_retention_days": "Audit Log Retention (days)",
        "allow_managed_rules_only": "Managed Rules Only"
      }
    },
    "dashboardMgmt": {
      "title": "Admin Dashboard",
    ...
    "riskMetrics": {
      "title": "Risk Control Metrics",
      "validateTotal": "Validated Total",
      "validatePass": "Validated Pass",
      "validateReject": "Validated Reject",
      "validateError": "Validated Error",
      "orderSendSuccess": "Order Sent Success",
      "orderSendFailed": "Order Sent Failed",
      "orderCloseSuccess": "Order Closed Success",
      "orderCloseFailed": "Order Closed Failed",
      "windowTitle": "Risk Window Metrics ({{window}})",
      "noRejectData": "No reject data",
      "noData": "No data",
      "rejectRiskCodes": "Top Reject Risk Codes ({{window}})",
      "rejectCount": "Reject Count"
    },
    "operationLogs": {
    ...
    "walletCalc": {
      ...
      "modelPlaceholder": "Select model (pricing basis)",
      "usdAmount": "USD Amount",
      "tokenAmount": "Token Amount",
      "fillResult": "Fill Calculation Result"
    },
    "walletMgmt": {
      "title": "Wallet Management",
      "userList": "User List",
      "searchPlaceholder": "Search account / email / nickname",
      "totalUsers": "{{count}} users",
      "noMatch": "No matching users",
      "noUsers": "No users",
      "walletDetail": "Wallet Detail: {{info}}",
      "accountNumber": "Account",
      "balance": "Balance",
      "frozen": "Frozen",
      "currency": "Currency",
      "adjustButton": "Adjust Balance (Grant / Deduct)",
    ...
    "sre": {
      "killSwitch": {
        "title": "Kill Switch",
        "subtitle": "One-click stop all trading — activation requires typing KILL; undo within 5 minutes",
        "engagedAlert": "Kill Switch engaged — all trading stopped",
        "disarmedAlert": "Kill Switch disarmed — trading running normally",
        "status": "Status",
        "reason": "Reason",
        "operator": "Operator",
        "engagedAt": "Engaged At",
        "undoWindow": "Undo window: {{minutes}}m {{seconds}}s remaining",
        "undoButton": "Undo Kill Switch",
        "refresh": "Refresh",
        "disengage": "Disengage Kill Switch",
        "engage": "Engage Kill Switch",
        "activateTitle": "Activate Kill Switch — Secondary Confirmation",
        "activateConfirm": "Confirm Activate",
        "activateWarning": "This will immediately stop all trading activity for all accounts, including pending orders and submitted orders. Please confirm by entering a reason and typing KILL.",
        "reasonLabel": "Activation Reason (required)",
        "reasonPlaceholder": "e.g. Abnormal market volatility detected, emergency stop all trading",
        "killConfirmLabel": "Type KILL to confirm activation",
        "killPlaceholder": "Type KILL (uppercase)",
        "engaged": "ENGAGED",
        "disarmed": "DISARMED"
      },
      "canary": {
        "title": "Canary Release Config",
        "subtitle": "New strategy versions run on a small set of accounts for N days before promotion to all",
        "refresh": "Refresh",
        "createCanary": "New Canary",
        "deleteConfirm": "Confirm delete this canary config?",
        "confirm": "Confirm",
        "cancel": "Cancel",
        "emptyCanaries": "No canary configs",
        "createTitle": "New Canary Release",
        "strategyId": "Strategy ID",
        "versionTag": "Version Tag",
        "canaryAccounts": "Canary Accounts",
        "startAt": "Start At",
        "durationDays": "Days",
        "promoted": "Promoted",
        "canaryRunning": "Canary Running",
        "accountIdsLabel": "Canary Account IDs (comma or newline separated)",
        "durationDaysLabel": "Canary Duration (days)"
      },
      "breakers": {
        "title": "Strategy Breakers",
        "subtitle": "Strategy circuit breaker status — auto-detects abnormal losses and trips",
        "refresh": "Refresh",
        "strategyId": "Strategy ID",
        "status": "Status",
        "totalPnl": "Total P&L",
        ...
        "reset": "Reset",
        "resetConfirm": "Confirm reset this breaker?",
        "confirm": "Confirm",
        "cancel": "Cancel",
