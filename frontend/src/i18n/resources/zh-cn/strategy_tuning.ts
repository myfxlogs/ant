...
const StrategyTuning = {
  "strategy": {
    "tuning": {
      ...
      "apply": "应用",
      "degradation": "衰减",
      "degradationTip": "用样本外数据测试时，收益相比样本内的下降比例。越低越好。",
      "enabledCombinations": "{{enabled}} 个启用 · {{combos}} 个组合",
      "grade": "评级",
      "gradeTip": "综合评分等级，A 最佳，E 最差。",
      ...
      "oosScore": "样本外评分",
      "oosScoreTip": "用未参与训练的历史数据重新回测后的得分，衡量策略在未见数据上的表现。",
      "optimizerMethod": "优化方法",
      "overfit": "过拟合",
      "overfitTip": "策略在训练数据上表现好，但在新数据上表现差，说明参数只是\"记住\"了历史而非真正有效。",
      "overfitWarning": "⚠ 过拟合",
      "parameterDimensions": "参数维度",
      "parameters": "参数",
      "parametersTip": "本次调优尝试的参数组合。",
      "preview": "预览信号",
      ...
      "run": "运行 ({{count}} 次回测)",
      "score": "评分",
      "scoreTip": "综合收益率、夏普比率、胜率、回撤等指标的加权评分，满分 100。",
      "started": "智能调优已启动",
      "summary": "摘要",
      "summaryTip": "对候选结果的简要描述。",
      "switchToDE": "切换到差分进化",
      "truncated": "已截断",
      "tuning": "调优中…",
