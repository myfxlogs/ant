const base = {
  ...
  marketplace: {
    ...
    messages: {
      ...
      subscribed: '購入済みに追加',
      subscribeFailed: '失敗',
      paymentComingSoon: '支払いはまもなく',
    },
    detail: {
      author: '作者', price: '価格',
      assetClass: 'アセットクラス', riskLevel: 'リスクレベル',
      subscribers: '購読者', avgRating: '評価',
      description: '説明', tags: 'タグ',
      getFree: '無料で入手', buyNow: '今すぐ購入',
      rentPrice: '¥{{amount}} / 月', buyPrice: '¥{{amount}} 買取',
      comments: 'コメント', noComments: 'コメントなし',
      commentPlaceholder: 'コメントを書く...',
    },
    purchases: {
      empty: 'まだ購入がありません。マーケットを見てみましょう。',
      strategy: '戦略', date: '購入日',
      status: '状態', actions: '操作',
    },
    author: {
      empty: 'まだ公開された戦略がありません。戦略ライブラリで公開してください。',
      published: '公開済み', subscribers: '購読者',
      avgRating: '平均評価', noPublished: '公開なし',
    },
    priceModel: { free: '無料', subscription: 'サブスク', performanceFee: '成功報酬' },
  },
