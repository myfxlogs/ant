...
import { SYSTEM_A_I_FIELDS_ENABLED_HINT_KEY, SYSTEM_A_I_FIELDS_MAX_TOKENS_HINT_KEY, SYSTEM_A_I_FIELDS_PRIMARY_FOR_HINT_KEY, SYSTEM_A_I_FIELDS_PRIMARY_FOR_KEY, SYSTEM_A_I_FIELDS_TEMPERATURE_HINT_KEY, SYSTEM_A_I_FIELDS_TIMEOUT_HINT_KEY, SYSTEM_A_I_STATUS_BAR_CHECKING_KEY, SYSTEM_A_I_STATUS_BAR_CONNECTED_KEY, SYSTEM_A_I_STATUS_BAR_DISABLED_KEY, SYSTEM_A_I_STATUS_BAR_ENABLED_KEY, SYSTEM_A_I_STATUS_BAR_KEY_READY_KEY, SYSTEM_A_I_STATUS_CONNECTION_FAILED_KEY } from '@/gen/ant/v1/i18n/ai_core_keys';
