...
export default function MarketRegimePage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card title={t(FORM_TRADING_TITLE_KEY)}>
        <Form form={form} layout="vertical" onFinish={handleSubmit} initialValues={{ timeframe: '15m' as const, count: 120 }}>
          ...
          <Space size="large" wrap>
            <Form.Item name="symbol" label={t(FORM_TRADING_SYMBOL_KEY)} rules={[{ required: true, message: t(FORM_SYMBOL_REQUIRED_KEY) }]}>
      ...
      {result && (
        <Card title={t(RESULT_TRADING_TITLE_KEY)}>
