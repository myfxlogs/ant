...
import {
  buildTradeColumns, buildHistoryColumns,
} from './BacktestHistoryDrawerHelpers';
...
const BacktestHistoryDrawer: React.FC<Props> = ({
  ...
  const tradeColumns = useMemo<ColumnsType<BacktestTrade>>(() => buildTradeColumns(t), [t]);
  ...
  const historyColumns: ColumnsType<unknown> = useMemo(() => buildHistoryColumns(t, onViewRun, onDeleteRun), [t, onViewRun, onDeleteRun]);
