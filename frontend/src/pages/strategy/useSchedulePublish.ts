import { MESSAGES_PUBLISH_FAILED_KEY, MESSAGES_TEMPLATE_PUBLISHED_KEY } from '@/gen/ant/v1/i18n/ai_wizard_keys';
import { DEFAULT_DRAFT_NAME_KEY, MESSAGES_BACKTEST_RUNNING_CANNOT_PUBLISH_KEY, MESSAGES_CANNOT_PUBLISH_AND_CREATE_DRAFT_FAILED_KEY, MESSAGES_MISSING_DRAFT_ID_CANNOT_PUBLISH_KEY, MESSAGES_PUBLISHED_BUT_NO_TEMPLATE_ID_KEY, MESSAGES_REPUBLISHED_BUT_NO_TEMPLATE_ID_KEY, MESSAGES_STRATEGY_CODE_EMPTY_CANNOT_PUBLISH_KEY, MESSAGES_TEMPLATE_ALREADY_PUBLISHED_KEY, MESSAGES_TEMPLATE_NOT_DRAFT_UNKNOWN_PUBLISH_STATUS_KEY, MESSAGES_TEMPLATE_REPUBLISHED_KEY } from '@/gen/ant/v1/i18n/strategy_templates_keys';
