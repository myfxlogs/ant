import { MESSAGES_CREATE_SCHEDULE_FAILED_KEY, MESSAGES_SCHEDULE_CREATED_AND_ENABLED_KEY, MESSAGES_SCHEDULE_CREATED_KEY } from '@/gen/ant/v1/i18n/ai_wizard_keys';
import { MESSAGES_MISSING_SCHEDULE_INFO_KEY, MESSAGES_READ_TEMPLATE_STATUS_FAILED_KEY, MESSAGES_TEMPLATE_NOT_PUBLISHED_CANNOT_CREATE_SCHEDULE_KEY, SCHEDULE_NAME_KEY } from '@/gen/ant/v1/i18n/strategy_templates_keys';
